...
import com.accenture.wizardInfoo.exceptions.server.InvalidWizardInfoException;
import com.accenture.wizardInfoo.exceptions.server.ServerErrorException;
...
public class ApiException {
    ...
    @ExceptionHandler(InvalidWizardInfoException.class)
    public Map<String, Object> validationError(InvalidWizardInfoException e) {
